    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward', models.CharField(blank=True, max_length=100, null=True, verbose_name='Вознаграждение за выполнение')),
                ...
                ('related_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='habit_app.habit', verbose_name='Связанная привычка')),
            ],
        ),
    ]
